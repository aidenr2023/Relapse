...
public class StunMine : MonoBehaviour, IPower
{
    #region Serialized Fields

    [SerializeField] private StunMineProjectile mineProjectilePrefab;
    ...
    public void Use(PlayerPowerManager powerManager, PowerToken pToken)
    {
        ...
        var projectile = Instantiate(mineProjectilePrefab, firePosition, Quaternion.identity);
